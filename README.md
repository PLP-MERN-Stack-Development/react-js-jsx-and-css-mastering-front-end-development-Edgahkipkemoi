...
### Task Manager
![Task Manager](https://via.placeholder.com/800x400/10B981/FFFFFF?text=Task+Manager+Page)

### API Data Integration
![API Data Page](https://via.placeholder.com/800x400/8B5CF6/FFFFFF?text=API+Data+Integration)
